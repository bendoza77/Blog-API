...
const { getPosts, getPublicPosts, createPost, getPostById, deletePostById, updatePostById } = require("../controllers/post.controller");
...
postRouter.route("/public").get(getPublicPosts);
